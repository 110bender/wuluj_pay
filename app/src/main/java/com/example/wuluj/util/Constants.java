...
public class Constants {
   ...
   */
  public static final String COUNTRY_CODE = "MA";
   ...
   */
  public static final String CURRENCY_CODE = "MAD";
   ...
   */
  public static final List<String> SHIPPING_SUPPORTED_COUNTRIES = Arrays.asList("MA", "FR");
